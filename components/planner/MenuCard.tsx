        ...
        <div className="mt-auto flex items-center justify-between gap-2 pt-2">
          ...
          {qty === 0 ? (
            <button
              ...
              className="inline-flex shrink-0 items-center gap-1 rounded-full bg-green px-3 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-green-hover"
            >

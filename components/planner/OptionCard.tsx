      ...
      <div className="mt-auto flex items-center justify-between gap-2 pt-2">
        ...
        {qty === 0 ? (
          <button
            ...
            className="inline-flex h-8 shrink-0 items-center gap-1 rounded-full bg-green px-3.5 text-[13px] font-semibold text-white transition-colors hover:bg-green-hover active:scale-95"
          >

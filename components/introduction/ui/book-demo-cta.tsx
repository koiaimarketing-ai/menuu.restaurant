 ...
 * and opens the shared Book Demo dialog with the trilingual label (`nav.demo`),
 * same as the navbar Book Demo button, so behaviour stays in one place.
 */
export function BookDemoCTA({
  ...
  return (
    <div className={`hidden justify-center md:flex ${className}`}>
      <Button size={size} onClick={openBookDemo}>
